...
<execution_context>
@~/.bob/gsd-core/workflows/mvp-phase.md
@~/.bob/gsd-core/references/spidr-splitting.md
@~/.bob/gsd-core/references/user-story-template.md
</execution_context>

<runtime_note>
**Bob (IBM):** Use `vscode_askquestions` wherever this workflow calls `AskUserQuestion`. Equivalent API.
</runtime_note>
...
<process>
Execute the mvp-phase workflow from @~/.bob/gsd-core/workflows/mvp-phase.md end-to-end.
