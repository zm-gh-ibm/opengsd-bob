...
<execution_context>
@~/.bob/gsd-core/workflows/add-todo.md
@~/.bob/gsd-core/workflows/note.md
@~/.bob/gsd-core/workflows/add-backlog.md
@~/.bob/gsd-core/workflows/plant-seed.md
@~/.bob/gsd-core/workflows/check-todos.md
