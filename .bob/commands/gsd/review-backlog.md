...
2. **Read ROADMAP.md** and extract all 999.x phase entries. Show each backlog item with its description, any accumulated context (CONTEXT.md, RESEARCH.md), and creation date.
...
6. **Commit changes** and print a summary of promoted/kept/removed items.
